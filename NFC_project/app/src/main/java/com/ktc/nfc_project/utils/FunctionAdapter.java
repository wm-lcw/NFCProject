 ...
 * @date 2023/1/4 15:43
 */
public class FunctionAdapter<T> extends BaseAdapter {

    private final List<AppInfo> mAppInfoList;
    private final Context mContext;
    private static final String TAG = "MyAdapter";

    public FunctionAdapter(@NonNull Context context, List<AppInfo> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.icon.setImageResource(ic_launcher);
        return convertView;
    }
